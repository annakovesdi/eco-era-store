    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_phone_number', models.CharField(blank=True, max_length=13, null=True)),
                ...
                ('default_addition', models.CharField(blank=True, max_length=5, null=True)),
                ('default_postcode', models.CharField(blank=True, max_length=6, null=True)),
