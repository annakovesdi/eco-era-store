...
def cache_checkout_data(request):
    try:
        payment_intent = request.POST.get('client_secret').split('_secret')[0]
        stripe.api_key = settings.STRIPE_SECRET_KEY
        stripe.PaymentIntent.modify(payment_intent, metadata={
        ...
        if request.user.is_authenticated:
            try:
                ...
                order_form = OrderForm(initial={
                    ...
                    'addition': profile.default_addition,
...
def checkout_success(request, order_number):
    ...
    if request.user.is_authenticated:
        ...
        if save_info:
            profile_data = {
                ...
                'default_addition': order.addition,
    ...
    messages.success(
        request, f'Thank you for your order. Your order '
